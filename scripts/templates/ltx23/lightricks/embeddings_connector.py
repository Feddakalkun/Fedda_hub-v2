...
class GatedCrossAttention(CrossAttention):
    def __init__(self, *args, gated=False, **kwargs):
        ...
        if gated:
            self.to_gate_logits = self.to_q.__class__(
    ...
    def forward(self, x, context=None, value=None, mask=None, pe=None, transformer_options={}):
        ...
        v = self.to_v(value)
        if pe is not None:
            q, k = comfy.ldm.modules.attention.apply_rope(q, k, pe)
